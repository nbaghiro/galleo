...
export const slowweb: ArtifactContent = doc("press", [
    ...
    section("pull-1", quote("The opposite of fast was never slow. It was deliberate.", "")),
    ...
    section(
        "stats",
        row(
            stat("2.5 hrs", "the average day now spent inside social feeds"),
            stat("47%", "of page views that end in under fifteen seconds"),
            stat("8 sec", "focused attention online, by one widely-cited measure"),
        ),
    ),
    ...
    section("pull-3", quote("That web was never deleted. It was only out-shouted.", "")),
