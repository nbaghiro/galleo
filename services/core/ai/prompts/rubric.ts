...
- A trio of cards, stats, or quotes is its OWN \`three-up\` row, one item per column, never a group packed into the narrow (40 percent) side of a split, where it collapses into a tall, cramped stack. The narrow side of a split holds ONE supporting thing (an image, a stat, a quote), not a group; to pair body copy with three cards, lead with the copy and give the cards a \`three-up\` of their own.
