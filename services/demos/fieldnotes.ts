...
export const fieldnotes: ArtifactContent = doc(
    ...
    [
        ...
        section("s4", "split-6040", {
            ...
            b: cell(img("faroe-torshavn-harbour-boats", 0.82)),
        }),
        ...
        section("s9", "split-6040", {
            ...
            b: cell(img("faroe-saksun-turf-church-lagoon", 0.82)),
        }),
        ...
        section("s11", "split-6040", {
            ...
            b: cell(img("faroe-mykines-puffins-cliff", 0.82)),
        }),
        section("s12", "full", {
            a: cell(
                group(
        ...
        section("s14", "split-6040", {
            ...
            b: cell(img("faroe-tjornuvik-sea-stacks", 0.82)),
        }),
        section(
            "s15",
            "full",
        ...
        section("s16", "three-up", {
            a: cell(stat("214 km", "walked — most of it uphill, all of it into wind")),
            b: cell(stat("9 of 14", "days of rain (the other five were merely threatening)")),
            c: cell(stat("63", "pages filled, perhaps a dozen of them legible")),
        }),
        section("s17", "split-4060", {
