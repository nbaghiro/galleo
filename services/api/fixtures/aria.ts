...
export const aria: ArtifactContent = deck(
    ...
    [
        ...
        section("s4", "split-6040", {
            ...
            b: cell(img("aria-tape-machine-studio", 0.82)),
        }),
        section(
            "s5",
            "full",
        ...
        section("s7", "three-up", {
            ...
            c: cell(group(img("aria-mood-wet-highway", 0.8), t("03 — The drive home", "caption"))),
        }),
        section("s8", "full", {
            a: cell(
                group(
        ...
        section("s11", "three-up", {
            a: cell(stat("31M", "streams across the singles")),
            b: cell(stat("240K", "pre-saves on Velvet Static")),
            c: cell(stat("1.4M", "followers across platforms")),
        }),
        section("s12", "split-6040", {
            ...
            b: cell(chart("line", "0.4, 0.7, 1.1, 1.9, 2.8, 3.6, 4.2", 240)),
        }),
        section("s13", "full", {
            a: cell(
                group(
