    ...
    [
        ...
        section(
            ...
            "full",
            {
                a: cell(
                    group(
                        t("Frequency 2026 · A design + technology festival", "eyebrow"),
                        t("Where design meets the machine.", "display"),
                        t(
        ...
        section("s3", "three-up", {
            ...
            b: cell(
                card(
                    ...
                    t("Meet your next collaborators", "title"),
                    t(
            ...
            c: cell(
                card(
                    ...
                    t("See it before everyone else", "title"),
                    t(
        ...
        section(
            ...
            "full",
            {
                a: cell(
                    group(
                        t("Three days that change how you build", "eyebrow"),
...
export const waitlistPage: ArtifactContent = web(
    ...
    [
        ...
        section("s9", "two-col", {
            a: cell(
                group(
                    t("Before you ask", "eyebrow"),
                    t("When do I get in?", "title"),
                    t(
        ...
        section(
            ...
            "full",
            {
                a: cell(
                    group(
                        t("Be first through the door", "eyebrow"),
