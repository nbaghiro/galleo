    ...
    [
        section(
            ...
            "full",
            {
                a: cell(
                    group(
                        t("SWITCHBOARD · SERIES A · 2026", "eyebrow"),
                        t("Never miss the call that pays the bills.", "display"),
                        t(
        ...
        section("a5", "split-6040", {
            a: cell(
                group(
                    t("02 — What we've proven", "eyebrow"),
    ...
    [
        section(
            ...
            "full",
            {
                a: cell(
                    group(
                        t("SIFT · PRODUCT TOUR", "eyebrow"),
                        t("Turn every customer signal into your next release.", "display"),
                        t(
        ...
        section("p10", "three-up", {
            a: cell(
                card(t("Support", "title"), t("Zendesk · Intercom · Front · Help Scout", "body")),
            ),
            b: cell(
                card(t("Sales & calls", "title"), t("Gong · Salesforce · HubSpot · Slack", "body")),
            ),
            c: cell(
                card(
                    t("Voice of customer", "title"),
        ...
        section(
            ...
            "full",
            {
                a: cell(
                    group(
                        t("Get started", "eyebrow"),
                        t(
                            "Stop guessing. Start shipping what customers actually asked for.",
                            "display",
                        ),
                        t(
