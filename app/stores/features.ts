...
import type { BoolFeature, ExportFormat, FeatureKey, NumFeature, PlanId } from "@model/billing";
import { PLANS, resolveFeatures } from "@model/billing";
...
// Read through these, never through the plan: only the resolved set carries the workspace's
// featureOverrides. Before /features loads, Free is the safe answer.
