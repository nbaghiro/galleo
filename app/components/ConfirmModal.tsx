...
// themed app tree so it inherits the active theme tokens. The caller owns the <Show> that mounts it and
// passes the copy + handlers; `danger` paints the primary button red, `busy` locks it while acting.
