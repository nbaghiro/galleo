    ...
    return (
        ...
        >
            <div class="flex items-center gap-2 border-b border-line px-5 py-4">
                ...
                <input
                    class="ml-auto w-55 rounded-md border border-line bg-canvas px-2.5 py-1.5 text-[13px] text-ink outline-none placeholder:text-muted focus:border-accent max-md:mr-9"
                    type="search"
