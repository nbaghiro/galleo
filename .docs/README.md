...
| **[architecture.md](architecture.md)** | The factual codebase map: every package + file, the `kernel → surfaces → services → app` layering (ESLint-enforced), path aliases, data flow, local ports. **Start here for "where does X live".** |
