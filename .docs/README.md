...
| [ai.md](ai.md)                     | The tool envelope + the patch · the generation resource · the tool catalog + pricing · the one executor · tracing · the chat / workspace agent · the prompt playbook · routes · the stored thread · client wiring |
