...
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | -------- |
| model pure contract            | `model/__tests__/{theme,text,ai,credits,features,billing,tools,target,authoring,geometry,section,digest,content,workspace}` | color/text/pricing/protocol math, real `@themes`                                                                                                                                                                                                                                                                                                                                                        | — (theme: `registerThemes`)               | DONE     |
...
| editor store + commands        | `editor/__tests__/{editor,commands,keymap,clipboard}`, `editor/core/__tests__/windowed`                                     | history/selection/commit reducers, `applyPatch`, windowed placeholders + resolution + undo across a load                                                                                                                                                                                                                                                                                                | clock (coalesce), injected transports     | DONE     |
...
| app route + stores             | `app/__tests__/route-context`, `app/stores/__tests__/{library,library-paging,search,save}`                                  | route derivers, formatters, search cache + ranking, keyset page append/dedupe, per-card fetch, autosave section-op diffs + fallback                                                                                                                                                                                                                                                                     | clock, `fetch`                            | DONE     |
...
| route policies (integration)   | `services/api/__tests__/*.itest.ts`                                                                                         | real Postgres, real SQL, auth cookie, gating/shaping; search runs the real generated tsvector; paging covers the keyset walk, windowed reads, and section-op writes                                                                                                                                                                                                                                     | DB (`galleo_test`), LLM/Stripe/mail/clock | DONE (8) |
