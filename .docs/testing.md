...
| ----------------- | ------------------------------------ | --------------- | ------------------------------------ | ---------------------------- | ------------------------ |
| **`unit`**        | `vitest.config.ts`                   | `**/*.test.ts`  | `node` (+ per-file happy-dom opt-in) | none (pure + injected seams) | **986 tests / 87 files** |
| **`integration`** | `vitest.integration.config.ts`       | `**/*.itest.ts` | `node`, `fileParallelism:false`      | real `galleo_test` Postgres  | **157 tests / 12 files** |
...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | -------- |
| model pure contract               | `model/__tests__/{theme,text,ai,credits,features,billing,tools,target,authoring,geometry,section,digest,content,workspace,comments,element-ids}` | color/text/pricing/protocol math, comment anchors + threads, the element-id walker, real `@themes`                                                                                                                                                                                                                                                                                                      | — (theme: `registerThemes`)               | DONE     |
| engine solver                     | `canvas/engine/__tests__/{layout,fragment,profile}`                                                                                              | Clay 3-pass solver, pagination, profile math                                                                                                                                                                                                                                                                                                                                                            | `measure`                                 | DONE     |
| elements ops + compose            | `canvas/elements/__tests__/{ops,compose,layouts,skeletons,spec,blueprint,element-ids}`                                                           | real registry, `DEFAULT_THEME.tokens`, profiles                                                                                                                                                                                                                                                                                                                                                         | `measure`                                 | DONE     |
...
| services AI schema + quality      | `services/core/ai/__tests__/{schema,quality}`                                                                                                    | real `zod`, deterministic gate                                                                                                                                                                                                                                                                                                                                                                          | —                                         | DONE     |
| services AI tools                 | `services/core/ai/tools/__tests__/{structure,manage,library,registry}`                                                                           | deterministic patch producers                                                                                                                                                                                                                                                                                                                                                                           | —                                         | DONE     |
| services media/mail/billing       | `services/core/__tests__/{generate,providers}`, `services/core/__tests__/mail`, `services/core/__tests__/stripe`                                 | pure dims/dispatch/escape/price mapping                                                                                                                                                                                                                                                                                                                                                                 | env (price ids, stock keys)               | DONE     |
| ui primitives (pure)              | `ui/__tests__/{focus,fuzzy,keys,palette}`                                                                                                        | focus-trap, fuzzy match, keymap, palette-model (sections, sources, snippet runs)                                                                                                                                                                                                                                                                                                                        | —                                         | DONE     |
