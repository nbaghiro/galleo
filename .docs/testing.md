...
| billing routes (integration)   | `services/api/__tests__/billing.itest.ts`                                                                         | real Postgres, credit engine (atomic spend/settle/ledger/top-ups), plan gating, owner gate, transactional webhooks, trials, seat floor                              | DB, Stripe SDK (`vi.mock("stripe")`)      | DONE     |
...
| media routes (integration)     | `services/core/__tests__/routes.itest.ts`                                                                         | storage cap on uploads (stored bytes only)                                                                                                                          | DB                                        | DONE     |
