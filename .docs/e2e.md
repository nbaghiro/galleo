...
5. The exception is the **plans project**, which moves the demo login onto the free workspace.
   `users.activeWorkspaceId` is one server-side pointer per person, not one per browser, so while
   it runs every other context signed in as demo reads the free plan: a publish 402s, an artifact
   create 402s, and the library is a different library. It runs first, alone, and every project
   sharing that login declares it as a dependency.
...
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| plans                     | the free plan's seat cap refuses an invite. The one spec that leaves the flagship, so it owns the demo login while it runs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| smoke                     | server healthy, auth gate renders, sign-in lands in the seeded library, a seeded artifact paints in the editor, a public link serves logged-out                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| editor                    | click-to-edit opens at the painted size with no scale jump; color swatch Auto → set → Reset; element dnd shows overlay indicators without a canvas repaint and drops at the line; one undo per gesture; section drag reorders through gap slots; edge autoscroll; Delete collapses the emptied column; ⌘D; Esc-walk; layout presets redistribute columns; a comment on an element posts, reveals its marker on section hover and reopens; a text-range comment keeps its quote and survives a later keystroke; threads whose element was deleted collect into their section's stack; the composer opens beside its element rather than at the section edge; a press outside the thread popover closes it and still lands where it was aimed; resolving clears the margin and the section's chip reveals the archive again; the resolve notice reopens the thread it just closed; Delete thread through the portaled overflow menu removes it for good; an inspector dropdown applies its option without closing the rail flyout; the rail flyout closes on an outside press while the inspector auto-open still wins; no comment chip on a part of a composite and one on the composite itself; two browser contexts on one artifact see each other in the roster, paint each other's cursor, and receive each other's edits live; an element one of them is typing in cannot be entered by the other |
| roles                     | owner/admin/member surface gating in the flagship workspace; plus-addressed emails render; the pinned invite joins the invited account                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| share                     | seeded public/private/protected slugs behave; UI-created link serves anonymously and dies on delete (verified via the links API before asserting)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| library                   | create/trash/restore round-trip through the row menu; the grid layout's carousel reaches a section, the default canvas layout draws the same cells, a plate takes the wheel only after the pointer holds still on it, and a switch to list survives a reload; search field and ⌘K find seeded content; a plain member's library comes back non-empty through the real client                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| auth (serial)             | UI signup provisions and signs in; wrong password anti-enumeration; forgot-flow acknowledgement; sweeps its own account from the e2e DB afterward                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| phone (Pixel 7 emulation) | first-tap-selects / second-tap-edits; the control bar anchors above the selection, centred, never overflowing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| present                   | present-mode keyboard walk; Export downloads real `%PDF` bytes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ai (dual-mode)            | chat → add-section tool → proposal card → apply lands the section; suggest-section-layouts returns cards and applying preserves the copy                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
```
pnpm test:e2e             # everything (build + DB + seed + 10 projects), ~2.5 min cold, ~36 s warm
...
- `editor/notes.spec.ts` — notes written in the panel reach the row and survive a reload. It waits on
  the `PATCH /artifacts/:id/content` rather than on a timeout, because the point of the test is that
  the write actually happened.
- `present/narration.spec.ts` — the play control is absent when nothing is prepared (an unconfigured
  deployment shows no dead button), the overview grid works from the editor now that it presents
  through the shared surface, and `N` shows the presenter's own script.
