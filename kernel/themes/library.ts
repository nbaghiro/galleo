...
// The curated theme system. Each theme is a coherent system: a font trio (display/body/mono), a heading
// weight, a corner radius, an optional border width + shadow, and a palette. `surface` = `cv`,
// `soft` = `ik`, `muted` = `mu`, `line` = `bd`, `onAccent` = `ai` (or white). `bw`/`sh` override the
// default 1px border / soft shadow.
